...
public class CropActivity extends DocumentScanActivity {
    ...
    protected void showProgressBar() {
        RelativeLayout rlContainer = findViewById(com.fbu.autonote.R.id.rlContainer);
    ...
    private void initView() {
        Button btnImageCrop = findViewById(com.fbu.autonote.R.id.btnImageCrop);
        Button btnClose = findViewById(com.fbu.autonote.R.id.btnClose);
        holderImageCrop = findViewById(com.fbu.autonote.R.id.holderImageCrop);
        imageView = findViewById(com.fbu.autonote.R.id.imageView);
        ImageView ivRotate = findViewById(com.fbu.autonote.R.id.ivRotate);
        ImageView ivInvert = findViewById(com.fbu.autonote.R.id.ivInvert);
        ImageView ivRebase = findViewById(com.fbu.autonote.R.id.ivRebase);
        btnImageCrop.setText(ScannerConstants.cropText);
        btnClose.setText(ScannerConstants.backText);
        polygonView = findViewById(com.fbu.autonote.R.id.polygonView);
        progressBar = findViewById(com.fbu.autonote.R.id.progressBar);
